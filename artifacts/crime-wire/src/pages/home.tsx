          ...
          <main className="lg:col-span-8">
            <article>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 border-t border-black pt-8">
                <button 
                  className="flex-1 border-2 border-black py-4 px-6 text-sm font-bold uppercase tracking-widest hover:bg-gray-100 transition-colors relative group"
                  onClick={() => alert("Digital edition will be available here every Thursday.")}
                >
                  <span className="block mb-1">Read the Latest Edition</span>
                  <span className="block text-[10px] font-normal tracking-normal normal-case text-gray-600">Edition link coming — check back Thursday</span>
                </button>
                <button 
        ...
        <section className="mt-8 border-t border-black pt-12 pb-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-black">
            ...
            <div className="px-6 py-4 md:py-0 flex flex-col items-center">
              ...
              <div className="w-32 h-32 border-4 border-black flex items-center justify-center mb-2 bg-gray-50">
                <span className="font-bold text-xl tracking-widest uppercase">QR</span>
              </div>
